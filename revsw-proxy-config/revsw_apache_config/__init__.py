...
def set_log(alog):
    """
    TODO: Ask what is this about. Is this a workaround?
    """
    global _log
    _log = alog
...
def configure_all(config):
    ...
    Args:
        config (dict): Configuration parameters generated by pc-apache-config script.
    """
